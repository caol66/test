#ifndef _HTTP__CODE__INCLUDE__
#define _HTTP__CODE__INCLUDE__
...
namespace unm
{
	namespace http
	{
		...
		public:
			static std::string GetHttpCodeDesc(EHttpCode eCode);

		private:
			static std::map<EHttpCode, std::string> m_mapHttpCodeDesc;
		};
	}
}
#endif
